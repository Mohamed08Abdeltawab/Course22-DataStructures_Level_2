...
namespace PriorityQueue
{
    ...
    public class MinHeapPriorityQueue
    {
        ...
        public void Insert(string name, int priority)
        {
            ...
            heap.Add(node);//adding node to the end of the list
        ...
        private void HeapifyUp(int index)
        {
            while (index > 0)
            {
                ...
                if (heap[index].Priority >= heap[parentIndex].Priority) break;// If the parent node's priority is less than or equal to its child's priority, we're done
